...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211206_loveisland1_2270302c3092b8629574_20211206013831_archive.zip';
	const ARCHIVE_SIZE		 = '53120438';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2270302-06013831';
    const SECONDARY_PACKAGE_HASH = '17dcd0b-06013831';
	const VERSION			 = '1.4.3';
