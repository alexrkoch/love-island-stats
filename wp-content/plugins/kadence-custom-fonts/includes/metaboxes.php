...
function kadence_custom_fonts_metaboxes() {
	...
	$kt_font_post->add_field(
		array(
			...
			'type'      => 'text',
			'attributes' => array(
				'data-conditional-id'    => $prefix . 'font_type',
	...
	$kt_font_post->add_field(
		array(
			...
			'desc'     => __( 'Upload .eot font file. No longer needed, depreciated option.', 'kadence-custom-fonts' ),
			'id'       => $prefix . 'font_eot',
			'type'     => 'file',
			// Optional:
			'options' => array(
	...
	$kt_font_post->add_field(
		array(
			...
			'desc'    => __( 'Upload .ttf font file. No longer needed, depreciated option.', 'kadence-custom-fonts' ),
			'id'      => $prefix . 'font_tiff',
			'type'    => 'file',
			'options' => array(
				'url' => false,
	...
	$kt_font_post->add_field(
		array(
			...
			'desc'    => __( 'Upload .svg font file. No longer needed, depreciated option.', 'kadence-custom-fonts' ),
			'id'      => $prefix . 'font_svg',
			'type'    => 'file',
			'options' => array(
				'url' => false,
