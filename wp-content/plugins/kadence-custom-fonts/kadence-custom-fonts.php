...
class Kadence_Custom_Fonts {
	...
	public function on_plugins_loaded() {
		...
		define( 'KT_CUSTOM_FONTS_VERSION', '1.1.1' );
	...
	public function on_init() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'typekit_custom_font_css' ), 100 );
	...
	public function add_block_fonts() {
		...
		if ( $fonts ) {
			...
			wp_enqueue_script( 'kadence_custom_fonts_block_scripts', KT_CUSTOM_FONTS_URL . 'assets/js/custom_fonts_blocks.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'wp-api', 'wp-edit-post' ), KT_CUSTOM_FONTS_VERSION, true );
