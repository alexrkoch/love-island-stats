...
class Archive_Meta {
	...
	public function __construct() {
		...
		add_action( 'edit_term', array( $this, 'update_tax_image' ), 10, 2 );
	...
	public function init() {
		...
		foreach ( $this->_taxonomies as $tax_name ) {
			add_action( $tax_name . '_edit_form_fields', array( $this, 'show_image_field' ), 11, 2 );
		}
	}
	/**
	 * Add media script.
	 ...
	 */
	public function update_tax_image( $term_id, $tt_id ) {
	...
	public function save_category_image ( $term_id, $tt_id ) {
		if( isset( $_POST['kwp-tax-image-id'] ) && '' !== $_POST['kwp-tax-image-id'] ){
			$image = $_POST['kwp-tax-image-id'];
			add_term_meta( $term_id, 'kwp-tax-image-id', $image, true );
		}
	}
	 ...
	 * Edit the form field
	 */
	public function show_image_field( $term, $taxonomy ) {
		?>
